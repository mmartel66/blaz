 ...
 * @Name ........ : sub.c
 * @Role ........ : Subtraction of two matrices given in files.
                    File names given as arguments in the
                    command line (argv[1] and argv[2]).
                    Comparison between the subtraction of
...
int main(int argc, char **argv) {
  ...
  result_matrix = blaz_sub(matrix_1, matrix_2);
  compressed_result_matrix = blaz_sub_compressed(compressed_matrix_1, compressed_matrix_2);
